...
& 'C:\Program Files (x86)\Java\jdk1.6.0_39\bin\jarsigner.exe' -verbose -sigalg SHA1withRSA -digestalg SHA1  -keystore ./Espera.keystore -signedjar ./Espera.Android/bin/Release/com.flagbug.esperamobile-signed.apk ./Espera.Android/bin/Release/com.flagbug.esperamobile.apk Espera
