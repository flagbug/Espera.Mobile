...
mkdir -Force ./Release
& 'C:\Program Files (x86)\Android\android-sdk\build-tools\20.0.0\zipalign.exe' -f -v 4 ./Espera.Android/bin/Release/com.flagbug.esperamobile-signed.apk ./Release/Espera.Android.apk